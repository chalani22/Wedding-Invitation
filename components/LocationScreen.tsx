...
const LocationScreen: React.FC<LocationScreenProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="relative py-24 px-6 md:px-12 bg-background-light overflow-hidden reveal">
      {/* Background Decorations */}
      <div className="absolute top-0 left-0 w-80 h-80 opacity-[0.05] pointer-events-none grayscale brightness-125 transition-transform duration-1000">
        <img 
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 opacity-[0.05] pointer-events-none rotate-180 grayscale brightness-125 transition-transform duration-1000">
        <img 
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Location Card */}
        <div className="bg-white rounded-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] overflow-hidden border border-primary/10 transition-all duration-700 hover:shadow-2xl reveal-scale">
          <div className="grid grid-cols-1 md:grid-cols-2">
            {/* Info Section */}
            <div className="p-10 md:p-16 lg:p-20 flex flex-col justify-center space-y-12">
              <div className="space-y-6">
                <div className="flex items-center gap-3 text-primary">
                  <span className="material-symbols-outlined text-2xl animate-pulse">hotel</span>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 h-14 rounded-lg border-2 border-primary text-[#1b190d] font-bold text-sm tracking-wide hover:bg-primary hover:text-white transition-all group"
                >
                ...
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 h-14 rounded-lg bg-primary text-[#1b190d] font-bold text-sm tracking-wide hover:brightness-110 transition-all shadow-lg shadow-primary/20 group"
                >
                  <span className="material-symbols-outlined text-xl transition-transform group-hover:scale-110 group-hover:rotate-12">directions</span>
            ...
            {/* Map Section */}
            <div className="relative min-h-[450px] md:min-h-full bg-primary/5 overflow-hidden group">
              <div className="absolute inset-0 grayscale contrast-[0.8] sepia-[0.2] opacity-80 transition-all duration-1000 group-hover:scale-110 group-hover:grayscale-0 group-hover:opacity-100">
                <div 
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                <div className="bg-primary text-[#1b190d] px-5 py-2 rounded-full text-[10px] font-bold shadow-2xl mb-1 flex items-center gap-2 whitespace-nowrap animate-bounce duration-2000">
